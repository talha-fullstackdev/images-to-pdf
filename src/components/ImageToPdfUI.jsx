...
const ImageToPdfUI = ({ properties }) => {
  // ✅ Destructuring all props from the passed `properties` object
  const {
    triggerFileInput,
    removeImage,
    handleDrop,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col items-center p-8">
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white p-8 rounded-xl shadow-2xl mb-8">
          ...
          {/* ✅ Safe to access images.length now */}
          {images.length > 0 && (
            <div className="mb-6">
        ...
        <p className="text-gray-700 mt-4 text-center">
          Developed and designed by <a
            ...
            className="text-indigo-600 hover:underline hover:underline-offset-4">Talha Nawaz</a>
        </p>
      </div>
